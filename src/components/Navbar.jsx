...
const Navbar = () => {
  ...
  return (
    <nav className="fixed text-white top-0 w-full z-50 bg-gradient-to-br from-black via-gray-900 to-gray-800  bg-background/80 backdrop-blur-lg border-b border border-border">
